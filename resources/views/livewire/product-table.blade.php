				...
				<div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200">
				  <div>
					...
					<div class="max-w-md space-y-3">
						<input type="search" wire:model.live.debounce.300="search" class="peer py-3 px-4 block w-full bg-gray-100 border-blue-500 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Search Product">
					</div>
						  ...
						  <tr wire:key="{{$product->id}}">
                              ...
                              <td class="size-px whitespace-nowrap">
                                <div class="px-6 py-1.5">
                                    <a
                                    href="#"
                                    onclick="if (confirm('Are you sure? Type DELETE to confirm') && prompt('Type DELETE to confirm') === 'DELETE') @this.call('delete', {{ $product->id }})"
                                    class="inline-flex items-center gap-x-1 text-sm text-red-500 decoration-2 hover:underline focus:outline-none focus:underline font-medium">
                                    Delete
                                    </a>
                                </div>
                             </td>
