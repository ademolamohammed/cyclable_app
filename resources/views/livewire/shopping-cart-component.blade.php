<section>
    ...
    <div class="mx-auto max-w-3xl">
      <header class="text-center flex gap-3">
        <h1 class="text-xl font-bold text-gray-900 sm:text-3xl mt-[8rem]">Your Cart</h1>
        ...
        <div class="mt-8 flex justify-end border-t border-gray-100 pt-8">
          <div class="w-screen max-w-lg space-y-4">
            ...
            <div class="flex justify-end gap-2">
              <a wire:navigate class="block rounded bg-[#039B00] px-5 py-3 text-sm text-gray-100 transition hover:bg-green-700" href="/">
                  Continue Shopping
                </a>
